        ...
        <!-- Session Status -->
            ...
            <form method="POST" action="{{ route('admin.login') }}">
                ...
                <div class="p-formEach">
                    <x-label  class="c-formLabel" for="email" :value="__('Email')" />
                ...
                <!-- Password -->
                <div class="p-formEach">
                    <x-label class="c-formLabel" for="password" :value="__('Password')" />
                ...
                <div class="p-formSubmit">
                    ...
                    @if (Route::has('admin.password.request'))
                        <a class="c-formLink" href="{{ route('admin.password.request') }}">
